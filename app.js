...
let state = {
  ...
  dailyQuestProgress: {}, dailyQuestDate: ''
};
let currentLang = 'kk';
...
function goToOnboardStep2() {
  ...
  const greets = {
    kk: `Жасаған, ${name}! 🎉 Ал, қанша жасындасың?`,
    ru: `Отлично, ${name}! 🎉 А сколько тебе лет?`,
    en: `Awesome, ${name}! 🎉 How old are you?`
  };
...
function goToOnboardStep3() {
  ...
  const name = document.getElementById('nameInputOnb').value.trim();
  const regionQ = {
    kk: `Керемет, ${name}! Қай облыстан екенсің? 📍`,
    ru: `Здорово, ${name}! Из какой ты области? 📍`,
    en: `Great, ${name}! Which region are you from? 📍`
  };
...
// MEMORY GAME
// ============================================================
const MEM_EMOJIS = ['A','K','Q','J','10','9','8','7'];
